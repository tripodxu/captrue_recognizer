...
通用 tncode 滑动验证码求解器。v5 算法在 37012 个代表性样例上达到 **96.8%** 准确率，配套反检测/人机行为模拟。
...
| **代表性数据集小计** | **37012** | **77.2%** | **96.5%** | **96.8%** | **+0.3** |
| Balanced 50/50 (压力测试) | 2878 | 41.0% | 49.9% | 68.2% | +18.3 |
| **总计** | **39890** | **74.4%** | **96.5%** | **95.8%** | — |

> Balanced 50/50 是从 v4f 失败案例中等量抽取构建的压力测试集，不具代表性，不计入代表性小计。
...
| Balanced (压力测试) | 2878 | 41.0% | 49.9% | **68.2%** |
